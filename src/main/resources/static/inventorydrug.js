        ...
        function loadTable(page,size,query) {
            page = page - 1;
            items = new Array();
           var data = httpRequest("/iteminventory/listbydrug?page="+page+"&size="+size+query,"GET");
            ...
            fillTable('tblItem',items,false,false,viewitem);
        ...
        function viewitem(itm,rowno) {
         ...
         function cmbItemTypeCH() {
             ...
             if(JSON.parse(cmbItemType.value).name == "Grocery"){
                 fillCombo(cmbGeneric,"Select Generic Name",generics,"name","Non");
         ...
         function cmbUnitCH(){
            if (item.itemtype_id.name == "Drug"){
                txtItemName.value = item.generic_id.name + " " + item.subcategory_id.name + " " + item.unit_id.name + " " + item.unit_id.unittype_id.name;
            }else{
                txtItemName.value = item.brand_id.name + " " + item.subcategory_id.name + " " + item.unit_id.name + " " + item.unit_id.unittype_id.name;
            }
